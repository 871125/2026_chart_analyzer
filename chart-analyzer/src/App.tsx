...
class BingXAPI {
    ...
    static generateMockData(): Candle[] {
        const candles: Candle[] = [];
        let time = Date.now() - 100 * 4 * 60 * 60 * 1000; 
        ...
        candles.push({ openTime: time, closeTime: time + 1000, open: 110, close: 114, low: 103, high: 115, isBullish: true, volume: 1000 }); time += 4 * 60 * 60 * 1000;
